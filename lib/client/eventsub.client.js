...
let i = require("..");
const eventsubClientOptions = require("../arguments/eventsub.client.options");
const createWs = require("../functions/createWs");
...
class eventsubClient {
    ...
    constructor(options) {
        ...
        let clientData = i.eventsubClientData[this.symbol] = {
            _options: _options,
            wsUrl: this.#wsUrl,
    ...
    async connect() {
        ...
        // return createWs(this.symbol);
        return await i.OberknechtAPI[this.symbol].verify();
    };
