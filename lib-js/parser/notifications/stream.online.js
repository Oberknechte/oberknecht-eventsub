...
exports.streamOnlineMessage = void 0;
const __1 = require("../..");
class streamOnlineMessage {
    ...
    async getStreamInformation() {
        return __1.i.OberknechtAPI[this.#sym].getStreams({
    ...
    constructor(sym, wsNum, response) {
        ...
        this.payload = {
            subscription: {
                ...
                condition: {
                    broadcasterUserID: response.payload.subscription.condition.broadcaster_user_id,
                },
                transport: {
...
exports.streamOnlineMessage = streamOnlineMessage;
